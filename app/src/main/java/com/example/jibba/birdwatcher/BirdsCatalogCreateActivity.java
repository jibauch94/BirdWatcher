...
public class BirdsCatalogCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_birds_catalog_create_obs);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent birdPictureIntent = new Intent(BirdsCatalogCreateActivity.this, BirdsCatalogCreateObs2Activity.class);
    ...
    private class GetBirds extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(BirdsCatalogCreateActivity.this,"Json Data is downloading",Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(BirdsCatalogCreateActivity.this, birdList,
